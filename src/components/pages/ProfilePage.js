        ...
        <Col sm="12" md="6" lg="3" className="mb-5">
          <Card>
            ...
            <CardBody>
              ...
              <CardTitle sub className="text-center indigo-text mb-2 font-bold">
                Photographer
              </CardTitle>
              <CardText>
                <strong className="mb-2">About:</strong>
                Lorem ipsum dolor sit amet consectetur, adipisicing elit.
                Ratione perferendis quod animi dignissimos consectetur quibusdam
                numquam laboriosam, minus, provident...
              </CardText>
